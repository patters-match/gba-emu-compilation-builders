...
If you have an EZ-Flash IV flash cart then take a look at my collection of [exit-patched emulators](https://github.com/patters-syno/gba-ezflash-iv-emulators).
