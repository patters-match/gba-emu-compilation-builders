...
- Use [my new fork of PCEAdvance v7.5]([https://github.com/patters-syno/msxadvance](https://github.com/patters-syno/pceadvance) with additional RAM support for EZ-Flash IV and EZ-Flash 3in1 flashcarts 
#### SMSAdvance
