...
default_emubinary = "ngpadvance.gba"
header_struct_format = "<8I31sc" # https://docs.python.org/3/library/struct.html

# ROM header
#
# from gba.h in the Cologne source code (there is no published NGPAdvance source) and Formats.txt in the binary distribution
#
#typedef struct {
#	u32 identifier;
#	u32 filesize;
...
if __name__ == "__main__":
	...
	parser.add_argument(
		dest = 'romfile',
		help = ".ngp ROM image to add to compilation. Drag and drop multiple files onto your shell window.",
	...
	parser.add_argument(
		'-e', 
		dest = 'emubinary',
		help = "NGPAdvance binary, defaults to " + default_emubinary,
		type = argparse.FileType('rb'),
